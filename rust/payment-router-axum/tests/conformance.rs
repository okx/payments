...
use payment_router_axum::{
    ...
    AdapterConfig, PaymentRouterConfig, PaymentRouterLayer, UnifiedRouteConfig,
};
use serde_json::{json, Value};
use tower::util::BoxCloneSyncService;
use tower::Service;

/// Placeholder typed config used by the conformance suite's `FakeAdapter`,
/// which doesn't read its config — just needs the slot to be present.
#[derive(Debug, Clone)]
struct DummyCfg;
