...
// SettleStatusChecker is an optional interface for FacilitatorClient implementations
// that support querying settlement status by transaction hash.
// Used for timeout recovery polling when settle returns status="timeout".
