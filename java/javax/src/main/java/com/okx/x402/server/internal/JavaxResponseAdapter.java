...
/** Adapts a javax {@link HttpServletResponse} to the servlet-agnostic core. */
public final class JavaxResponseAdapter implements X402Response {

    private final HttpServletResponse delegate;

    public JavaxResponseAdapter(HttpServletResponse delegate) {
